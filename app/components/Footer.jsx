        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Your one-stop destination for discovering and managing amazing products. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/items" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Products
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Email: info@producthub.com</li>
